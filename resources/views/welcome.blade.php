...
<head>
    ...
    <!-- BOOTSTRAP CSS -->
    <link id="style" href="client/assets/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet">
=
    <!-- STYLE CSS -->
     <link href="client/assets/css/style.css" rel="stylesheet">

	<!-- Plugins CSS -->
    <link href="client/assets/css/plugins.css" rel="stylesheet">

    <!--- FONT-ICONS CSS -->
    <link href="client/assets/css/icons.css" rel="stylesheet">

    <!-- INTERNAL Switcher css -->
    <link href="client/assets/switcher/css/switcher.css" rel="stylesheet">
    <link href="client/assets/switcher/demo.css" rel="stylesheet">
...
<body class="app sidebar-mini ltr light-mode">
                ...
                <div class="container-fluid main-container">
                    <div class="d-flex">
                        ...
                        <a class="logo-horizontal " href="index.html">
                            <img src="client/assets/images/brand/logo-white.png" class="header-brand-img desktop-logo" alt="logo">
                            <img src="client/assets/images/brand/logo-dark.png" class="header-brand-img light-logo1"
                                alt="logo">
                        </a>
                        <!-- LOGO -->
                ...
                <div class="app-sidebar">
                    <div class="side-header">
                        <a class="header-brand1" href="index.html">
                            <img src="client/assets/images/brand/logo-white.png" class="header-brand-img desktop-logo" alt="logo">
                            <img src="client/assets/images/brand/icon-white.png" class="header-brand-img toggle-logo"
                                alt="logo">
                            <img src="client/assets/images/brand/icon-dark.png" class="header-brand-img light-logo" alt="logo">
                            <img src="client/assets/images/brand/logo-dark.png" class="header-brand-img light-logo1"
                                alt="logo">
                        </a>
                        <!-- LOGO -->
    ...
    <!-- BOOTSTRAP JS -->
    <script src="client/assets/plugins/bootstrap/js/popper.min.js"></script>
    <script src="client/assets/plugins/bootstrap/js/bootstrap.min.js"></script>

    <!-- SPARKLINE JS-->
    <script src="client/assets/js/jquery.sparkline.min.js"></script>

    <!-- Sticky js -->
    <script src="client/assets/js/sticky.js"></script>

    <!-- CHART-CIRCLE JS-->
    <script src="client/assets/js/circle-progress.min.js"></script>

    <!-- PIETY CHART JS-->
    <script src="client/assets/plugins/peitychart/jquery.peity.min.js"></script>
    <script src="client/assets/plugins/peitychart/peitychart.init.js"></script>

    <!-- SIDEBAR JS -->
    <script src="client/assets/plugins/sidebar/sidebar.js"></script>

    <!-- Perfect SCROLLBAR JS-->
    <script src="client/assets/plugins/p-scroll/perfect-scrollbar.js"></script>
    <script src="client/assets/plugins/p-scroll/pscroll.js"></script>
    <script src="client/assets/plugins/p-scroll/pscroll-1.js"></script>

    <!-- INTERNAL CHARTJS CHART JS-->
    <script src="client/assets/plugins/chart/Chart.bundle.js"></script>
    <script src="client/assets/plugins/chart/utils.js"></script>

    <!-- INTERNAL SELECT2 JS -->
    <script src="client/assets/plugins/select2/select2.full.min.js"></script>

    <!-- INTERNAL Data tables js-->
    <script src="client/assets/plugins/datatable/js/jquery.dataTables.min.js"></script>
    <script src="client/assets/plugins/datatable/js/dataTables.bootstrap5.js"></script>
    <script src="client/assets/plugins/datatable/dataTables.responsive.min.js"></script>

    <!-- INTERNAL APEXCHART JS -->
    <script src="client/assets/js/apexcharts.js"></script>
    <script src="client/assets/plugins/apexchart/irregular-data-series.js"></script>

    <!-- INTERNAL Flot JS -->
    <script src="client/assets/plugins/flot/jquery.flot.js"></script>
    <script src="client/assets/plugins/flot/jquery.flot.fillbetween.js"></script>
    <script src="client/assets/plugins/flot/chart.flot.sampledata.js"></script>
    <script src="client/assets/plugins/flot/dashboard.sampledata.js"></script>

    <!-- INTERNAL Vector js -->
    <script src="client/assets/plugins/jvectormap/jquery-jvectormap-2.0.2.min.js"></script>
    <script src="client/assets/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>

    <!-- SIDE-MENU JS-->
    <script src="client/assets/plugins/sidemenu/sidemenu.js"></script>

	<!-- TypeHead js -->
	<script src="client/assets/plugins/bootstrap5-typehead/autocomplete.js"></script>
    <script src="client/assets/js/typehead.js"></script>

    <!-- INTERNAL INDEX JS -->
    <script src="client/assets/js/index1.js"></script>

    <!-- Color Theme js -->
    <script src="client/assets/js/themeColors.js"></script>

    <!-- CUSTOM JS -->
    <script src="client/assets/js/custom.js"></script>

    <!-- Custom-switcher -->
    <script src="client/assets/js/custom-swicher.js"></script>

    <!-- Switcher js -->
    <script src="client/assets/switcher/js/switcher.js"></script>
